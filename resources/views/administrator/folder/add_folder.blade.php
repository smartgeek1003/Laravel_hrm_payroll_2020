                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group{{ $errors->has('folder_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="textarea text-description" name="folder_description" id="folder_description" placeholder="{{ __('Enter client description..') }}">{{ old('folder_description') }}</textarea>
                                @if ($errors->has('folder_name'))
                                <span class="help-block">
