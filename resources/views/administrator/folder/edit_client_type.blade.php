        ...
        <div class="box box-default">
            ...
            <form action="{{ url('/setting/client-types/update/'. $client_type['id']) }}" method="post" name="client_type_edit_form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('client_type') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="client_type" id="client_type" class="form-control" value="{{ $client_type['client_type'] }}" placeholder="{{ __('Enter client name..') }}">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group{{ $errors->has('client_type_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="textarea" name="client_type_description" id="client_type_description" placeholder="{{ __('Enter client description..') }}" class="text-description">{{ $client_type['client_type_description'] }}</textarea>
                                @if ($errors->has('client_type'))
                                <span class="help-block">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-edit"></i> {{ __('pdate client type') }}U</button>
                </div>
            </form>
        </div>
        <!-- /.box -->
