...
@section('title', __('Add Employee Awards'))
  ...
  <section class="content">
    ...
    <div class="box box-default">
      <div class="box-header with-border">
        <h3 class="box-title">{{ __('Add employee awards') }} </h3>
      ...
      <!-- /.box-header -->
      <form action="{{ url('/hrm/employee-awards/store') }}" method="post" name="employee_award_add_form">
        {{ csrf_field() }}
        <div class="box-body">
          <div class="row">
            <!-- Notification Box -->
            <div class="col-md-12">
              ...
              @else
              <p class="text-yellow">{{ __('Enter Employee Awards List. All field are required.') }} </p>
              @endif
            </div>
            <!-- /.Notification Box -->
            ...
            <div class="col-md-6">
              ...
              <div class="form-group{{ $errors->has('gift_item') ? ' has-error' : '' }} has-feedback">
                <input type="text" name="gift_item" id="gift_item" class="form-control" value="{{ old('gift_item') }}" placeholder="{{ __('Enter Gift Item..') }}">
              ...
              <!-- /.form-group -->
                ...
                <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }} has-feedback">
                  <textarea class="textarea text-description" name="description" id="description" placeholder="{{ __('Enter employee award description..') }}">{{ old('description') }}</textarea>
...
document.forms['employee_award_add_form'].elements['publication_status'].value = "{{ old('publication_status') }}";
</script>
