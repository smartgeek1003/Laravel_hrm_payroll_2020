...
@section('title', __('Add Expence Category'))
...
<div class="content-wrapper wow fadeInDown" data-wow-duration=".5s" data-wow-delay=".2s">
  ...
  <section class="content">
    ...
    <div class="box box-default">
      ...
      <!-- /.box-header -->
      <form action="{{ url('/hrm/expence/category/store') }}" method="post" name="add_form_expence">
        {{ csrf_field() }}
        <div class="box-body">
          <div class="row">
            <!-- Notification Box -->
            ...
            <div class="form-group">
              <input type="text" name="exp_name" class="form-control" placeholder="{{ __('Enter Purpose Name') }}">
            </div>
        ...
        <div class="box-footer">
          ...
          <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i> {{ __('Add Category') }}</button>
        </div>
      </form>
    </div>
    <!-- /.box -->
