    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <div class="col-md-12">
          ...
          <form class="form-horizontal" action="{{ url('/hrm/salary/statement/view') }}" method="get">
            {{ csrf_field() }}
            ...
            <div class="form-group{{ $errors->has('user_id') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-3">
                <select name="emp_id" id="user_id" class="form-control">
                  ...
                  <option value="{{ $employee['user_id'] }}"><strong>[ID{{$employee->id}}] {{ $empname }} [{{ date("F Y", strtotime($employee['payment_month'])) }}]</option>
                    @endforeach
                  </select>
