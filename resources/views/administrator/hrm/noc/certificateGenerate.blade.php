    ...
    <section id="payslip_new">
        <div class="container">
           ...
           @foreach($nocs as $noc)
            ...
            <div class="row">
                <div class="col-lg-12">
                    <center><h1>{{__('TO WHOM IT MAY CONCERN')}}</h1></center>
            ...
            <div class="row">
             ...
             <div class="myprint">
                    ...
                    <a href="{{url('hrm/certificate/list')}}"><button class="btn btn-primary"><i class="fa fa-download"></i> {{ __('Back') }}</button></a>
