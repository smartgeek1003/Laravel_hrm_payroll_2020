...
====================================*/
    ...
    .container{
        border:5px solid #A40C0C;
    }
    .myprint{background: #A40C0C;}
    ...
    <section id="payslip_new">
        <div class="container">
           ...
           @foreach($nocs as $noc)
            <div class="row" >
                ...
                <div class="col-lg-12 header_main clear-fix">
                    ...
                    <div class="brand_logo">
                        <b>Date:</b>
                     <h5>{{ $noc->created_at->format('d/m/Y')}}</h5>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                   <center><h2>{{__('NO OBJECTION CERTIFICATE')}}</h2></center>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="Signature_container">
                        ...
                        <div class="Employer_sign">
                            <div class="act_signature">
                                <h4>{{__('Administration Signature')}}</h4>
                            </div>
                        </div>
                    </div>
                </div>
             ...
             <div class="myprint">
                    ...
                    <a href="{{url('hrm/noc/list')}}"><button class="btn btn-primary"><i class="fa fa-download"></i> {{ __('Back') }}</button></a>
