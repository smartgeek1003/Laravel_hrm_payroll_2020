...
@section('title', __('Add reference'))
...
<div class="content-wrapper wow fadeInDown" data-wow-duration=".5s" data-wow-delay=".2s">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="{{ url('/dashboard') }}"><i class="fa fa-dashboard"></i> {{ __('Dashboard') }}Dashboard</a></li>
            <li><a href="{{ url('/people/references') }}">{{ __('References') }}</a></li>
            <li class="active">{{ __('Add reference') }}</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title">{{ __('Add reference') }}</h3>
            ...
            <form action="{{ url('people/references/store') }}" method="post" name="reference_add_form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('contact_no_two') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="contact_no_two" id="contact_no_two" class="form-control" value="{{ old('contact_no_two') }}" placeholder="{{ __('Enter address..') }}">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i>{{ __(' Add reference') }}</button>
                </div>
            </form>
        </div>
        <!-- /.box -->
