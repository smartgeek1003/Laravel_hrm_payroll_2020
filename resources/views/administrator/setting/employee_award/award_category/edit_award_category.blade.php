...
@section('title', __('Update Award Category'))
...
<div class="content-wrapper wow fadeInDown" data-wow-duration=".5s" data-wow-delay=".2s">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">{{ __('Update Award Category') }}</li>
    </ol>
  </section>
  ...
  <section class="content">
    ...
    <div class="box box-default">
      <div class="box-header with-border">
        <h3 class="box-title">{{ __('Update Award Category') }}</h3>
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              @else
              <p class="text-yellow">{{ __('Update Awards Title. All field are required.') }} </p>
              @endif
            </div>
            <!-- /.Notification Box -->
