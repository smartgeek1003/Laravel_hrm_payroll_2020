...
@section('title', __('Details of job type'))
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">{{ __('Details of job type') }}</h3>
            ...
            <div class="box-body">
                <a href="{{ url('/setting/job-types') }}" class="btn btn-primary btn-flat"><i class="fa fa-arrow-left"></i> {{ __('Back') }}</a>
                <hr>
